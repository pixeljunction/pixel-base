...
/*
* This file declares the options to add to the theme options
* and sets the name of the options to which they are stored
* within.
*/

/***************************************************************
* Function optionsframework_option_name()
* Defines the name to use in which to store the options
***************************************************************/
function optionsframework_option_name() {

	/* sets up the name of the options in the database */
	$themename = 'pxjn_theme_options';
